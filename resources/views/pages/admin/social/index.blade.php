                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title ">List Social</h3>
                            <a href="{{ route('social.create') }}" class="btn btn-primary">Tambah Data</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="text-right">
                                                        ...
                                                        <a
                                                            onclick="return confirm('Yakin untuk menghapus social {{$item->title}}? ')">
